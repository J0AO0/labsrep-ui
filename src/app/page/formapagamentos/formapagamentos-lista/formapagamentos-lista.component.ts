...
export class FormaPagamentosListaComponent implements OnInit {
  ...
  filtro: FiltrosFormaPagamentos = new FiltrosFormaPagamentos(); // Inicializando o filtro
  ...
  ngOnInit() {
    ...
    this.title.setTitle('Forma de Pagamento');
    this.carregarFormaPagamento();
  ...
  carregarFormaPagamento() {
    ...
    this.formaService.listarComFiltro(this.filtro) // Passando o objeto filtro completo
      .then(obj => {
